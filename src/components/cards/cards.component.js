    ...
    <>
        ...
        <div className="shape-box shape-box_half">
            ...
            <figcaption>
                <div class="show-cont">
                    <h3 class="card-no">Frontend Dev</h3>
                    <h4 class="card-main-title">Partwheeler</h4>
                </div>
        ...
        <div className="shape-box shape-box_half">
            ...
            <figcaption>
                <div class="show-cont">
                    ...
                    <h4 class="card-main-title">Proof Redesign</h4>
                </div>
        ...
        <div class="shape-box shape-box_half">
            ...
            <figcaption>
                <div class="show-cont">
                    <h3 class="card-no">UX Design</h3>
                    <h4 class="card-main-title">Hairtoppers</h4>
                </div>
        ...
        <div class="shape-box shape-box_half">
            ...
            <figcaption>
                <div class="show-cont">
                    ...
                    <h4 class="card-main-title">YAMA Adventures</h4>
                </div>
